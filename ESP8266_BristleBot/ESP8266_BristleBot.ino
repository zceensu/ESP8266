...
#define RIGHT 5    // Corresponds to GPIO5 labelled pin D1 on NodeMCU board
#define LEFT 15    // Corresponds to GPIO15 labelled pin D8 on NodeMCU board
...
void loop() {
    ...
    if(currentMillis - previousMillis >= PROXIMITY_INTERVAL) {
     ...
     if (frontdet ) {
        ...
        distance = "Back Dist. L: " + String(pulselengthL) + " R:" + String(pulselengthR);
