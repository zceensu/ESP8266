...
char organization[] = "lj3tej";                   // Your BlueMix Organisation ID
...
char authToken[] = "*****";          // The authentication token generated by your BlueMix application

const char MQTTSTRING[] = "{\"d\":{\"myName\":\"TILaunchPad\",\"temperature\":%.2f,\"X\":%i,\"Y\":%i,\"Z\":%i,\"RSSI\":%i}}";
